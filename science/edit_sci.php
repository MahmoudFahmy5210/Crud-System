...
if (isset($_POST['update']))
{
    ...
    {            
        ...
        //updating the table
        $result = mysqli_query($conn, "UPDATE sci SET title='$title_',author_first_name='$fstname_',author_last_name='$lstname_' WHERE id=$id_sci");
...
$result = mysqli_query($conn,"SELECT * FROM sci WHERE id=$id_sci") or die("Error: " . mysqli_error($conn));
...
<body>
    ...
    <br><br><br>
    <form name="form_edit" method="post" action="edit_sci.php">
        <table border="2">
            <tr> 
                <td>Title</td>
